;;; And lets add rock-explosion noise...
...
.makeExplosionSoundOnShift: {
    lda keyShiftLAST : bne done
    lda keyShift : beq done
    jmp makeExplosionSound
.done:
    rts
    }

.speedUpOnSpace: {
    lda keySpaceLAST : bne done
    lda keySpace : beq done
    jmp c0decreasePeriod
.done:
    rts
    }
